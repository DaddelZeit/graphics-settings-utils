...
local function retrieveDefaults()
    local tbl = {}
    tableMerge(tbl, require("core/settings/lightingQuality").qualityLevels[settings.getValue("GraphicLightingQuality")])
    tableMerge(tbl, require("core/settings/meshQuality").qualityLevels[settings.getValue("GraphicMeshQuality")])
    tableMerge(tbl, require("core/settings/textureQuality").qualityLevels[settings.getValue("GraphicTextureQuality")])
    tableMerge(tbl, require("core/settings/shaderQuality").qualityLevels[settings.getValue("GraphicShaderQuality")])
    return tbl
end
...
local function getDefaults()
    ...
    local tbl = {
        ...
        ["$pref::lightManager"] = {
            ...
            default = defaultSettings["$pref::lightManager"],
            ptr = defaultSettings["$pref::lightManager"],
        },
        ["$pref::Shadows::filterMode"] = {
            name = "Filter Mode",
            desc = "Changes the way shadow edges are handled.",
            default = defaultSettings["$pref::Shadows::filterMode"],
            ptr = defaultSettings["$pref::Shadows::filterMode"],
        },
        ["$pref::Shadows::textureScalar"] = {
            ...
            default = defaultSettings["$pref::Shadows::textureScalar"],
            ptr = im.FloatPtr(defaultSettings["$pref::Shadows::textureScalar"])
        },
        ...
        ["$pref::GroundCover::densityScale"] = {
            ...
            default = settings.getValue("GraphicGrassDensity"),
            ptr = im.FloatPtr(settings.getValue("GraphicGrassDensity")),
        },
        ["$pref::TS::maxDecalCount"] = {
            name = "Maximum Tire Marks",
            desc = "How many tire marks can exist in a scene.",
            default = settings.getValue("GraphicMaxDecalCount"),
            ptr = im.IntPtr(settings.getValue("GraphicMaxDecalCount")),
        },
        ["$pref::TS::detailAdjust"] = {
            name = "Mesh LOD Scale",
            desc = "The smaller the value the closer the camera must get to see the highest level of detail. This setting can have a huge impact on performance in mesh heavy scenes.",
            default = defaultSettings["$pref::TS::detailAdjust"],
            ptr = im.FloatPtr(defaultSettings["$pref::TS::detailAdjust"])
        },
        ["$pref::Terrain::lodScale"] = {
            name = "Terrain LOD Scale",
            desc = "A global level of detail scale used to tweak the default terrain screen error value.",
            default = defaultSettings["$pref::Terrain::lodScale"],
            ptr = im.FloatPtr(defaultSettings["$pref::Terrain::lodScale"]),
        },
        ...
        ["$pref::Terrain::detailScale"] = {
            ...
            default = defaultSettings["$pref::Terrain::detailScale"],
            ptr = im.FloatPtr(defaultSettings["$pref::Terrain::detailScale"]),
        },
        ["$pref::Reflect::refractTexScale"] = {
            ...
            default = defaultSettings["$pref::Terrain::detailScale"],
            ptr = im.FloatPtr(defaultSettings["$pref::Reflect::refractTexScale"])
        },
        ["$pref::Video::textureReductionLevel"] = {
            name = "Texture Reduction Level",
            desc = "Reduces texture resolution/quality.",
            default = defaultSettings["$pref::Video::textureReductionLevel"],
            ptr = im.IntPtr(defaultSettings["$pref::Video::textureReductionLevel"])
        },
        ...
        ["$pref::Camera::distanceScale"] = {
            ...
            desc = "A scale to apply to the normal visible distance, typically used for tuning performance.",
            default = 1,
            ptr = im.FloatPtr(1)
        },
