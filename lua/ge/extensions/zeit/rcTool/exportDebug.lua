...
local function getPlatform()
    local platformInfo = {
        ...
        steam = {
            ...
            accountIDStr = Steam.getAccountIDStr(),
            accountLoggedIn = Steam.accountLoggedIn,
            --authTicked = Steam.authTicked,
            --authTickedValidated = Steam.authTickedValidated,
            branch = Steam.branch,
...
local function export()
    ...
    local files = {"/beamng.log", "/beamng.1.log", "/beamng.2.log", "/beamng-dxDiag.txt", "/beamng-launcher.log", "/beamng-launcher.1.log", "/beamng-launcher.2.log"}
