...
local function toggleDebug(bool)
    if bool then
        M.onUpdate = isEnabled and (doVehicle and autoFocusDebug or autoFocusNoVehicle) or nop
    else
        M.onUpdate = isEnabled and (doVehicle and autoFocus or autoFocusNoVehicle) or nop
    end
end
