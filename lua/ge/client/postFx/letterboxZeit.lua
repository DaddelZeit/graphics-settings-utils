...
LetterboxPostFX.uvY1 = 0.1
LetterboxPostFX.uvY2 = 0.9
...
LetterboxPostFX.setShaderConsts = function (uvY1, uvY2, Color)
  -- log('I','postfx','Calling setShaderConsts from LetterboxFx')
